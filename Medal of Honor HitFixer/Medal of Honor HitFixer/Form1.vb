...
Public Class Form1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If CheckBox1.Checked = True Then
            If ping <= 0 Then
                MsgBox("Error, invalid ping value. Must be higher than 0.", MsgBoxStyle.Critical, "MOHHF - Error!")
            Else
                ...
                Dim settings As New IO.FileStream(DocFolder + "\EA Games\Medal of Honor\Multiplayer\settings.ini", IO.FileMode.Append, IO.FileAccess.Write, IO.FileShare.None)
                ...
                myFileWriter.Close()
                settings.Close()
                MsgBox("Medal of Honor hit registration should has been fixed!", MsgBoxStyle.Information, "MOHHF - Done!")
            End If
        Else
            If ping <= 0 Then
                MsgBox("Error, invalid ping value. Must be higher than 0.", MsgBoxStyle.Critical, "MOHHF - Error!")
            Else
                Dim linesList As New List(Of String)(File.ReadAllLines(DocFolder + "\EA Games\Medal of Honor\Multiplayer\settings.ini"))
                Dim i As Integer = 0
                While i <> 4
                    linesList.RemoveAt(29)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        While i <> 4
            linesList.RemoveAt(29)
            File.WriteAllLines(DocFolder + "\EA Games\Medal of Honor\Multiplayer\settings.ini", linesList.ToArray())
            i = i + 1
        End While
        MsgBox("Medal of Honor hit registration restored to default!", MsgBoxStyle.Information, "MOHHF - Done!")
    End Sub
