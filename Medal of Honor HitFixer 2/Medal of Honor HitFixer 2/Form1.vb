...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim HFSettingsFile As String = DocFolder & "\EA Games\Medal of Honor\Multiplayer\MOH_HF\settings.ini"
        ...
        Dim ValuesFile As String = DocFolder & "\EA Games\Medal of Honor\Multiplayer\MOH_HF\values.ini"
    ...
    Private Sub Form1_Close(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.FormClosing
        ...
        'Creating Folder
        System.IO.Directory.CreateDirectory(DocFolder & "\EA Games\Medal of Honor\Multiplayer\MOH_HF\")

        'Creating HitFixer Settings File
        Dim SettingsFile As New IO.FileStream(DocFolder & "\EA Games\Medal of Honor\Multiplayer\MOH_HF\settings.ini", IO.FileMode.Create, IO.FileAccess.Write, IO.FileShare.None)
        ...
        If Me.CheckBox3.Checked = True Then
            Dim ValuesFile As New IO.FileStream(DocFolder & "\EA Games\Medal of Honor\Multiplayer\MOH_HF\values.ini", IO.FileMode.Create, IO.FileAccess.Write, IO.FileShare.None)
        ...
        'Remove Fix From Medal of Honor Settings File
        If Me.CheckBox4.Checked = True Then
            Dim MOHSettingsFile As String = DocFolder & "\EA Games\Medal of Honor\Multiplayer\settings.ini"
            If System.IO.File.Exists(MOHSettingsFile) Then
                Dim lines = IO.File.ReadAllLines(MOHSettingsFile)
                ...
                If latComp > 0 And extraFrame > 0 And extraTime > 0 And interTime > 0 Then
                    ...
                    IO.File.WriteAllLines(MOHSettingsFile, lines)
                End If
            End If
        End If
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        'Reading Medal of Honor Settings File
        Dim SettingsFile As String = DocFolder & "\EA Games\Medal of Honor\Multiplayer\settings.ini"
        If System.IO.File.Exists(SettingsFile) Then
            ...
            'Writing Medal of Honor Settings File
            ...
            If ping <= 0 Then
                MsgBox("Error, invalid ping value. Must be higher than 0.", MsgBoxStyle.Critical, "MOH_HF2 - Error!")
            Else
                ...
                If latComp > 0 And extraFrame > 0 And extraTime > 0 And interTime > 0 Then
                    ...
                    MsgBox("Medal of Honor hit registration should has been fixed!", MsgBoxStyle.Information, "MOH_HF2 - Done!")
                Else
            ...
            End If
        Else
            MsgBox("Cannot find the Medal of Honor Settings file!", MsgBoxStyle.Critical, "MOH_HF2 - Error!")
        End If
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If System.IO.File.Exists(SettingsFile) Then
            ...
            'Restoring Medal of Honor Settings File
            If latComp > 0 And extraFrame > 0 And extraTime > 0 And interTime > 0 Then
                Dim tempList As New List(Of String)(lines)
                tempList.RemoveAt(latComp)
                tempList.RemoveAt(extraFrame - 1)
                ...
                lines = tempList.ToArray
                IO.File.WriteAllLines(SettingsFile, lines)
                MsgBox("Medal of Honor has been restored at its default state!", MsgBoxStyle.Information, "MOH_HF2 - Done!")
            Else
                MsgBox("It seems Medal of Honor is already at its default state!", MsgBoxStyle.Critical, "MOH_HF2 - Error!")
            End If
        Else
            MsgBox("Cannot find the Medal of Honor Settings file!", MsgBoxStyle.Critical, "MOH_HF2 - Error!")
        End If
